...
- **No schema list to maintain** — every non-generic `#[derive(Schema)]`
  type is collected automatically, and reachable generic instantiations
  follow transitively (with explicit registration and a no_std / WASM
  opt-out when you need them).
