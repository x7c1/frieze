//! chrono field shapes under OAS 3.0, behind the opt-in `chrono04`
//! feature. `Option<DateTime<Utc>>` inlines to a nullable scalar, which
//! 3.0 encodes as `nullable: true` alongside `type: string`.
//!
...
#[test]
fn chrono_fields_render_as_string_with_date_formats_under_oas_3_0() {
