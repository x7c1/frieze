...
## Composing with a hand-written document
...
[Doc comments to `description`](field-shapes.md#doc-comments-to-description)
...
[Wire names](field-shapes.md#wire-names-rename-and-rename_all).
...
[composite shapes table](field-shapes.md#composite-shapes-presence-x-nullability)
...
[`oas-versions.md`](oas-versions.md) for the full encoding
