...
`docs/field-shapes/generics.md` around the "primitive references are inlined" section).
...
- [x] `docs/field-shapes/generics.md` documents the reserved-name rejection next to
      the primitive-inline section, mentioning `ReservedSchemaName`
      (`grep -q ReservedSchemaName docs/field-shapes/generics.md` is appended to
