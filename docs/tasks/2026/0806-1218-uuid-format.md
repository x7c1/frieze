...
- CI (`.github/workflows/ci.yml`): add build/clippy/test steps for the
  ...
  describes the matrix, `docs/oas-versions.md`.
- Docs: extend `docs/field-shapes.md` with the `uuid::Uuid` field shape
...
- [x] The reserved-name enumerations in the error messages include `Uuid`,
      ...
      match.
- [x] `docs/field-shapes.md` documents the `uuid::Uuid` mapping including
